...
useEffect(() => {
  ...
  const sendOtp = async (userData) => {
      ...
      const otpResponse = await axios.post("http://localhost:8000/api/v1/auth/authRoutes/sendOtp/forgotPass", userData);
...
// Function to handle going back to the previous step
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      ...
      const changePasswordRes = await axios.post("http://localhost:8000/api/v1/auth/authRoutes/signin/changePassword", userResponse );
