...
export default function PricingDefault() {
  ...
  const onClickPricing = async (price) => {
    ...
    try {
      ...
      const checkoutOptions = {
        ...
        }/payment-status?order_id=${res.data.order_id}`,
      };
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      {/* Logo above Pricing Plans */}
      <div className="flex flex-col items-center mb-6">
        <img
          src="/logo.png"
          alt="Brand Logo"
          className="h-28 w-28 rounded-2xl mb-2 drop-shadow-lg"
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <Card className="text-center transform hover:scale-105 transition-transform duration-300">
          ...
          <p className="text-4xl font-extrabold mt-2 text-gray-800 dark:text-gray-300">
            ₹499
          </p>
        ...
        <Card className="text-center border-2 border-blue-500 transform hover:scale-105 transition-transform duration-300">
          ...
          <Button color="blue" onClick={() => onClickPricing(999)}>
            Choose Plan
          </Button>
        </Card>
        ...
        <Card className="text-center transform hover:scale-105 transition-transform duration-300">
          ...
          <Button color="dark" onClick={() => onClickPricing(1499)}>
            Choose Plan
          </Button>
        </Card>
      </div>
