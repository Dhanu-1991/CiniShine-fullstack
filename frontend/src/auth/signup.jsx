...
// Function to send OTP to the user
  ...
  const sendOtp = async (userData) => {
      ...
      const otpResponse = await API.post("/api/v1/auth/authRoutes/sendOtp/signup", userData);
...
// Function to handle going back to the previous step
  ...
  const handleFinalSignup = async (e) => {
    ...
    try {
      ...
      const signupRes = await API.post("/api/v1/auth/authRoutes/signup", userResponse );
